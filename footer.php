...
<!--                        <h2 class="block-title">PRASDEL</h2>-->
                        ...
                        <ul class="mt-3 footer-social">
                            ...
                            <!--                            <li><a class="instagram" href="#"><i class="lni-whatsapp"></i></a></li>-->
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="site-info text-center">
                        <p>Designed and Developed by <a href="https://tyd.or.tz/" rel="nofollow"><span style="color:#024b6d;"><strong>TYD Innovation Incubator</strong></span></a></p>
                    </div>
                </div>
            </div>
        </div>
